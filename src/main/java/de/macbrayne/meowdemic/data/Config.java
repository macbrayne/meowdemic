...
public record Config(float incubationTimeMultiplier, float recoveryTimeMultiplier, float immunityTimeMultiplier,
    ...
    public Config withImmunityTimeMultiplier(float newImmunityTimeMultiplier) {
        return new Config(incubationTimeMultiplier(), recoveryTimeMultiplier(), newImmunityTimeMultiplier, radiusMultiplier(), vaccineMultiplier(), foodMultiplier(), minimumSpreadTime());
    }

    public Config withRadiusMultiplier(float newRadiusMultiplier) {
        return new Config(incubationTimeMultiplier(), recoveryTimeMultiplier(), immunityTimeMultiplier(), newRadiusMultiplier, vaccineMultiplier(), foodMultiplier(), minimumSpreadTime());
    }

    public Config withVaccineMultiplier(float newVaccineMultiplier) {
        return new Config(incubationTimeMultiplier(), recoveryTimeMultiplier(), immunityTimeMultiplier(), radiusMultiplier(), newVaccineMultiplier, foodMultiplier(), minimumSpreadTime());
    }

    public Config withFoodMultiplier(float newFoodMultiplier) {
        return new Config(incubationTimeMultiplier(), recoveryTimeMultiplier(), immunityTimeMultiplier(), radiusMultiplier(), vaccineMultiplier(), newFoodMultiplier, minimumSpreadTime());
    }

    public Config withMinimumSpreadTime(int newMinimumSpreadTime) {
        return new Config(incubationTimeMultiplier(), recoveryTimeMultiplier(), immunityTimeMultiplier(), radiusMultiplier(), vaccineMultiplier(), foodMultiplier(), newMinimumSpreadTime);
    }
    ...
    public static Config defaultConfig() {
        return new Config(1.0f, 1.0f, 1.0f, 10.0f, 2.0f, 0.85f, 80);
    }
}
